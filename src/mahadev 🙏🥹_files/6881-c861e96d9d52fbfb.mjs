"use strict";(self.modernJsonp=self.modernJsonp||[]).push([[6881,61257],{25690:(e,t,n)=>{n.d(t,{default:()=>a});var i=n(718222);let r=`pulsing {
  ...
  `;return{className:t,styles:`
    ...
    ${g}
  `}}({gutterWidth:en,flexible:U,items:y,isRTL:X,itemWidth:et,maxColumns:e.maxColumns??Math.max(y.length,S.g5),minColumns:ei,getColumnSpanConfig:T,_getResponsiveModuleConfigForSecondItem:z}),ef=`${ed} ${ec}`.trim(),{anyEnabled:ey,expName:eg,group:ex,isMeasureAllEnabled:eb}=(0,h.Z)(),ev=((0,i.useRef)(void 0),(0,i.useRef)(y.length)),ew=(0,i.useRef)(0),eC=(0,i.useRef)(null);(0,i.useEffect)(()=>{ev.current=y.length,ew.current+=1},[y]),(0,i.useEffect)(()=>{if(es.current&&(es.current=!1),window.earlyGridRenderStats){let e=(0,k.M3)({earlyHydrationGroup:J,handlerId:Q,requestContext:Z});(0,R.nP)("earlyHydrationDebug.masonry.earlyGridRender.status",{tags:e}),(0,R.LY)("earlyHydrationDebug.masonry.earlyGridRender.init",window.earlyGridRenderStats.init,{tags:e}),window.earlyGridRenderStats.start&&(0,R.LY)("earlyHydrationDebug.masonry.earlyGridRender.start",window.earlyGridRenderStats.start,{tags:e}),window.earlyGridRenderStats.end&&(0,R.LY)("earlyHydrationDebug.masonry.earlyGridRender.end",window.earlyGridRenderStats.end,{tags:e})}},[]),(0,i.useEffect)(()=>()=>{},[]);let eS=(0,i.useCallback)(e=>{let t=e.reduce((e,t)=>e+t),n=t/e.length;(0,R.S0)("webapp.masonry.multiColumnWhitespace.average",n,{sampleRate:1,tags:{experimentalMasonryGroup:ex||"unknown",handlerId:Q,isAuthenticated:H,multiColumnItemSpan:e.length}}),(0,R.S0)("webapp.masonry.twoColWhitespace",n,{sampleRate:1,tags:{columnWidth:et,minCols:ei}}),D({event_type:15878,component:14468,aux_data:{total_whitespace_px:t}}),D({event_type:16062,component:14468,aux_data:{average_whitespace_px:n}}),D({event_type:16063,component:14468,aux_data:{max_whitespace_px:Math.max(...e)}}),e.forEach(t=>{t>=50&&((0,R.nP)("webapp.masonry.multiColumnWhitespace.over50",{sampleRate:1,tags:{experimentalMasonryGroup:ex||"unknown",handlerId:Q,isAuthenticated:H,multiColumnItemSpan:e.length}}),D({event_type:16261,component:14468})),t>=100&&((0,R.nP)("webapp.masonry.multiColumnWhitespace.over100",{sampleRate:1,tags:{experimentalMasonryGroup:ex||"unknown",handlerId:Q,isAuthenticated:H,multiColumnItemSpan:e.length}}),D({event_type:16262,component:14468}))}),(0,R.nP)("webapp.masonry.multiColumnWhitespace.count",{sampleRate:1,tags:{experimentalMasonryGroup:ex||"unknown",handlerId:Q,isAuthenticated:H,multiColumnItemSpan:e.length}})},[et,D,ei,H,Q,ex]),{_items:e_,_renderItem:eM}=function({initialLoadingStatePinCount:e=50,infiniteScrollPinCount:t=10,isFetching:n,items:r=[],renderItem:a,isLoadingStateEnabled:o}){let l=+(r.filter(e=>"object"==typeof e&&null!==e&&"type"in e&&"closeup_module"===e.type).length>0),s=o&&n,u=(0,i.useMemo)(()=>Array.from({length:r.length>l?t:e}).reduce((e,t,n)=>[...e,{height:n%2==0?356:236,key:`skeleton-pin-${n}`,isSkeleton:!0}],[]),[r.length,l,t,e]);return{_items:(0,i.useMemo)(()=>s?[...r,...u]:r,[s,r,u]),_renderItem:(0,i.useMemo)(()=>o?e=>{let{itemIdx:t,data:n}=e;return t>=r.length&&n&&"object"==typeof n&&"key"in n&&"height"in n?(0,x.jsx)(C,{data:n},n.key):a(e)}:a,[o,a,r.length])}}({isLoadingStateEnabled:A,items:y,renderItem:(0,i.useCallback)(e=>(0,x.jsx)(l.Z,{name:"MasonryItem",children:G(e)}),[G]),isFetching:m,initialLoadingStatePinCount:P}),e$=A&&m,eR=(0,i.useRef)(new Set);(0,i.useEffect)(()=>{if(!eu)return;let e=setTimeout(()=>{requestAnimationFrame(()=>{let e=Array.from(eC.current?.querySelectorAll("[data-grid-item-idx]")??[]);if(0===e.length)return;let t=e.map(e=>{let t=e.getAttribute("data-grid-item-idx");return{rect:e.getBoundingClientRect(),itemIdx:t}}),n=0,i=0,r=0,a=0,o=0,l=0;for(let e=0;e<t.length;e+=1){let s=t[e]?.rect,u=t[e]?.itemIdx;for(let m=e+1;m<t.length;m+=1){let e=t[m]?.rect,p=t[m]?.itemIdx;if(s&&e&&u&&p){let t=[u,p].sort().join("|");if(!eR.current.has(t)&&s.right>=e.left&&s.left<=e.right&&s.bottom>=e.top&&s.top<=e.bottom&&s.height>0&&e.height>0){eR.current.add(t),n+=1;let u=Math.max(0,Math.min(s.right,e.right)-Math.max(s.left,e.left))*Math.max(0,Math.min(s.bottom,e.bottom)-Math.max(s.top,e.top));u>8e4?l+=1:u>4e4?o+=1:u>1e4?a+=1:u>5e3?r+=1:u>2500&&(i+=1)}}}}n>0&&(0,R.QX)("webapp.masonry.pinOverlapHits",n,{tags:{isAuthenticated:H,isDesktop:N,handlerId:Q,experimentalMasonryGroup:ex||"unknown",fluidResizeExperiment:em?"true":"false",visualSearchSTLexperiment:ep?"true":"false"}}),i>0&&(0,R.QX)("webapp.masonry.pinOverlap.AreaPx.over2500",i,{tags:{isAuthenticated:H,isDesktop:N,handlerId:Q,experimentalMasonryGroup:ex||"unknown",fluidResizeExperiment:em?"true":"false",visualSearchSTLexperiment:ep?"true":"false"}}),r>0&&(0,R.QX)("webapp.masonry.pinOverlap.AreaPx.over5000",r,{tags:{isAuthenticated:H,isDesktop:N,handlerId:Q,experimentalMasonryGroup:ex||"unknown",fluidResizeExperiment:em?"true":"false",visualSearchSTLexperiment:ep?"true":"false"}}),a>0&&(0,R.QX)("webapp.masonry.pinOverlap.AreaPx.over10000",a,{tags:{isAuthenticated:H,isDesktop:N,handlerId:Q,experimentalMasonryGroup:ex||"unknown",fluidResizeExperiment:em?"true":"false",visualSearchSTLexperiment:ep?"true":"false"}}),o>0&&(0,R.QX)("webapp.masonry.pinOverlap.AreaPx.over40000",o,{tags:{isAuthenticated:H,isDesktop:N,handlerId:Q,experimentalMasonryGroup:ex||"unknown",fluidResizeExperiment:em?"true":"false",visualSearchSTLexperiment:ep?"true":"false"}}),l>0&&(0,R.QX)("webapp.masonry.pinOverlap.AreaPx.over80000",l,{tags:{isAuthenticated:H,isDesktop:N,handlerId:Q,experimentalMasonryGroup:ex||"unknown",fluidResizeExperiment:em?"true":"false",visualSearchSTLexperiment:ep?"true":"false"}})})},1e3);return()=>{clearTimeout(e)}},[et,ex,em,H,N,eu,y,Q,ep]);let ek=(0,a.Z)(),ej=(0,i.useCallback)(e=>{w&&(w.current=e)},[w]);return(0,x.jsxs)(i.Fragment,{children:[A&&!es.current&&(0,x.jsx)(r.xu,{"aria-live":"polite",display:"visuallyHidden",children:e$?F:O}),(0,x.jsx)("div",{ref:eC,"aria-busy":A?!!e$:void 0,className:"masonryContainer","data-test-id":"masonry-container",id:s,style:V?{padding:`0 ${en/2}px`}:void 0,children:(0,x.jsxs)("div",{className:ef,children:[K&&es.current?(0,x.jsx)(g.Z,{"data-test-id":"masonry-ssr-styles",unsafeCSS:eh}):null,(0,x.jsx)(r.xu,{"data-test-id":"max-width-container",marginBottom:0,marginEnd:"auto",marginStart:"auto",marginTop:0,maxWidth:e.maxColumns?ea*e.maxColumns:void 0,children:ey?(0,x.jsx)(r.GX,{ref:ek?ej:e=>{w&&(w.current=e)},_dynamicHeights:!0,_getResponsiveModuleConfigForSecondItem:z,_logTwoColWhitespace:eS,_measureAll:eb,align:t,columnWidth:et,getColumnSpanConfig:T,gutterWidth:en,items:e_,layout:U?ee:b??"basic",loadItems:v,measurementStore:eo,minCols:ei,renderItem:eM,scrollContainer:el,virtualBufferFactor:.3,virtualize:E}):(0,x.jsx)(r.Rk,{ref:ek?ej:e=>{w&&(w.current=e)},_dynamicHeights:!0,_fluidResize:em,_getResponsiveModuleConfigForSecondItem:z,_logTwoColWhitespace:eS,align:t,columnWidth:et,getColumnSpanConfig:T,gutterWidth:en,items:e_,layout:U?ee:b??"basic",loadItems:v,measurementStore:eo,minCols:ei,renderItem:eM,scrollContainer:el,virtualBufferFactor:.3,virtualize:E})})]})})]})}},399083:(e,t,n)=>{n.d(t,{Z:()=>i});function i(e=!0){let t=e?16:void 0,n=t?Math.floor(t/4):void 0;return{experimentalColumnWidth:e?221:void 0,experimentalGutter:t,experimentalGutterBoints:n}}}}]);
//# sourceMappingURL=https://sm.pinimg.com/webapp/6881-c861e96d9d52fbfb.mjs.map